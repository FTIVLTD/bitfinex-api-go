...
See [examples](https://github.com/FTIVLTD/bitfinex-api-go/tree/master/examples) and [doc.go](https://github.com/FTIVLTD/bitfinex-api-go/blob/master/doc.go) for more examples.
